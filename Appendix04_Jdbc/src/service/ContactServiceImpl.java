...
public class ContactServiceImpl implements ContactService {
	...
	public void addContact() {
		...
		String name = sc.next();
		System.out.println("신규 연락처 번호 >>> ");
		String tel = sc.next();
		System.out.println("신규 연락처 이메일 >>> ");
		String email = sc.next();
		System.out.println("신규 연락처 주소 >>> ");
		...
		System.out.println(addResult + "개의 연락처가 등록 되었습니다.");
	}
	...
	public void modifyContact() {
		...
		System.out.println("======== 연락처 수정하기 =========");
		 ...
		 int contact_no = sc.nextInt();
		 ContactDTO contact = dao.selectContactByNo(contact_no);	//  수정하기 전의 내용을 저장한 contact 객체가 됨
		...
		default   :
			...
			return;		// return문을 통헤 메소드 자체를 종료하기
		 }
		 
		 int modifyResult = dao.updateCcontact(contact);
