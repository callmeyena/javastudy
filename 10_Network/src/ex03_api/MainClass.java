...
//		String encodingKey = "V1ZK022TM9GGs2XJ7sSMDYk96j604sERtTiWDwdidJi2F%2BjuYRL98yvX55ovOn5gygCQs6e33EDBB1cqdDRuwQ%3D%3D";	// 인코딩		
//		String apiURL = "http://openapi.airport.co.kr/service/rest/AirportCodeList/getAirportCodeList";
//		apiURL += "?serviceKey=" + encodingKey;   // 이 방법 ㄴㄴ
		
		
		String serviceKey = "V1ZK022TM9GGs2XJ7sSMDYk96j604sERtTiWDwdidJi2F+juYRL98yvX55ovOn5gygCQs6e33EDBB1cqdDRuwQ==";		// 디코딩
		String apiURL = "http://openapi.airport.co.kr/service/rest/AirportCodeList/getAirportCodeList"; // 주소 만드는 과정
		URL url = null;
		...
		try {
			...
			apiURL += "?serviceKey=" + URLEncoder.encode(serviceKey, "UTF-8");	// 주소창에 parameter를 붙이는 것도 GET방식
			url = new URL(apiURL);
			con = (HttpURLConnection) url.openConnection();
			
			con.setRequestMethod("GET"); // 무조건 대문자료 표기. 요청하고자 하는 파라미터를 ?뒤에 붙이면 무조건 GET방식 / 요청방식
			con.setRequestProperty("Content-Type", "application/xml; charset=UTF-8"); // 내려받을 데이터 타입
			...
			System.out.println("공항코드정보.xml이 생성 되었습니다.");
	...
	public static void ex02() {
		...
		*/
		...
		try {
			...
			System.out.println("국제선운항스케줄.xml이 생성 되었습니다.");
