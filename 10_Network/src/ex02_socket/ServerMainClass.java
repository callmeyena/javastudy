...
public class ServerMainClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// InetSocketAddress: Socket 사용 시 "호스트", "포트번호(채널번호 같은 것)" 를 관리하는 클래스 => 주소를 알아야 통신을 할 수 있다.
			...
			while(true) { 
				...
				// 클라이언트의 접속 요청을 허용
				Socket clientSocket = serverSocket.accept(); // localhost9090에 누군가 오기 전까지
				
				// 클라이언트 접속 확인을 위해서 InetSocektAddress를 활용
